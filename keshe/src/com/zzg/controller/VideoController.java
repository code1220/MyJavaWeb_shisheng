...
import com.zzg.entity.Page;
import com.zzg.entity.Video;
import com.zzg.service.VideoService;
...
public class VideoController {
	...
	public ModelAndView list(Integer currPage,String soukey){
		...
		int totalCount=Integer.parseInt(videoService.findCount(key).get(0).get("count(id)").toString());
//		System.out.println(totalCount);
		...
		List<Map<String,Object>> list=videoService.findAll(index,pageSize,key);
		mv.addObject("list", list);
		mv.addObject("key",soukey);
		mv.setViewName("video_list");
...
//		filename = new String(filename.getBytes("iso-8859-1"),"utf-8");
	...
	public ModelAndView deleteMore(String[] sel)  {
		videoService.deleteMore(sel);
		return list(1,null);
	}
	
	@RequestMapping(value="/goPlay")
	public ModelAndView goPlay(String id){
		List<Map<String,Object>> list=null;
		ModelAndView mv=new ModelAndView();
		list= videoService.findById(id);
		mv.addObject("list",list);
		mv.setViewName("video_play");
		return mv;
	}
