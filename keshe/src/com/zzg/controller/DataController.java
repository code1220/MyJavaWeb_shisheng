...
import com.zzg.service.DataService;
...
public class DataController {
	...
	public ModelAndView list(Integer currPage,String soukey){
		...
		int totalCount=Integer.parseInt(dataService.findCount(key).get(0).get("count(id)").toString());
