    	...
    	<form id="form1" class="center-block" action="" method="post">
		    ...
		    <td>
		    	<select class="form-control" id="type" name="type">
		    		...
		    		<option <c:if test="${list[0].type eq '灌水'}">selected</c:if> value="灌水">灌水</option>
		    		<option <c:if test="${list[0].type eq '技术交流'}">selected</c:if> value="技术交流">技术交流</option>
		    		<option <c:if test="${list[0].type eq '网事杂谈'}">selected</c:if> value="网事杂谈">网事杂谈</option>
		    		<option <c:if test="${list[0].type eq '我要求助'}">selected</c:if> value="我要求助">我要求助</option>
		    	</select>
		    </td>
		    </tr>
		    <tr>
